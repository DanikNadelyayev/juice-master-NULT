...
// --- ВИПРАВЛЕННЯ: Ключі беруться з ENV ---
const privateKey = process.env.JWT_PRIVATE_KEY || ''
if (!privateKey) {
  console.warn('WARNING: JWT_PRIVATE_KEY is not set. Authentication may fail.')
}

const hmacSecret = process.env.JWT_HMAC_SECRET || ''
if (!hmacSecret) {
  console.warn('WARNING: JWT_HMAC_SECRET is not set.')
}
// ------------------------------------------
...
// --- ВИПРАВЛЕННЯ: Використання змінної замість хардкоду ---
